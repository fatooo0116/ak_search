...
class SearchBox extends React.Component{
  ...
  render(){
    ...
    const redirectPage = (this.props.isSearchAction) ?  <><Redirect to={searchUrl} /></>  :'';
    ...
    return(
      ...
      <div className="search_box">    
          ...
          <FormControl >
              <Select value={1}>
                <MenuItem value={1}>全文搜索</MenuItem>
                <MenuItem value={2}>要件搜索</MenuItem>              
              </Select>                             
          </FormControl>          
          <button type="button"  onClick={ () => this.props.onSearchByText(this.props.input) } >

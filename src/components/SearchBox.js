...
class SearchBox extends React.Component{
  ...
  render(){
        ...
        let redirectGo = (me.props.isSearchAction==true) ? <Redirect to={searchPath} ></Redirect> : "";   
                
        if(this.props.path){
          if(!this.props.path.path=='/search/:id'){ redirectGo=''; }
        }
    ...
    return(
      <form      className="main_search" onSubmit={(e) => {  e.preventDefault();    this.props.onSearchByText(this.props.input, this.props.selectValue, this.props.paged); }}>
